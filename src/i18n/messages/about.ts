...
export const aboutMessages: Record<Locale, AboutMessages> = {
  en: {
    ...
    factory: {
      ...
      paragraph:
        "Haisen operates factory-direct production for cabinets, power distribution and enclosure systems, with in-house engineering for electrical, mechanical and thermal design. Production is organized around standard catalog specifications as well as project-configured builds for micro modular and containerized data center orders.",
    },
    qualityControl: {
      eyebrow: "Assurance",
    ...
    globalMarkets: {
      ...
      paragraph:
        "Haisen exports data center infrastructure products and project solutions to the Middle East, Africa, Southeast Asia, Europe, South America and Central Asia, supporting distributors, wholesalers, EPC contractors and direct end-user projects.",
    },
    engineering: {
      eyebrow: "Engineering Support",
      title: "Custom Solutions & Project Delivery",
      paragraph:
        "Beyond catalog products, Haisen's engineering team supports project-specific configuration — from PDU outlet layout and cabinet dimensions to complete micro modular and containerized data center system design — backed by technical documentation and delivery coordination for overseas projects.",
    },
  ...
  ar: {
    ...
    factory: {
      ...
      paragraph:
        "تدير هايسِن إنتاجاً مباشراً من المصنع للخزانات وأنظمة توزيع الطاقة والهياكل، مع هندسة داخلية للتصميم الكهربائي والميكانيكي والحراري. يُنظَّم الإنتاج حول المواصفات القياسية للكتالوج، بالإضافة إلى الإنتاج المُهيأ حسب المشروع لطلبات مراكز البيانات المعيارية المصغرة والحاوية.",
    },
    qualityControl: {
      eyebrow: "ضمان الجودة",
      title: "مراقبة الجودة",
    ...
    globalMarkets: {
      ...
      paragraph:
        "تُصدّر هايسِن منتجات البنية التحتية لمراكز البيانات وحلول المشاريع إلى الشرق الأوسط وأفريقيا وجنوب شرق آسيا وأوروبا وأمريكا الجنوبية وآسيا الوسطى، وتدعم الموزعين وتجار الجملة ومقاولي EPC ومشاريع المستخدمين النهائيين المباشرة.",
    },
    engineering: {
      eyebrow: "الدعم الهندسي",
      title: "حلول مخصصة وتسليم المشاريع",
      paragraph:
        "بالإضافة إلى منتجات الكتالوج، يدعم فريق هندسة هايسِن التكوين الخاص بكل مشروع — من تخطيط منافذ PDU وأبعاد الخزانات إلى تصميم أنظمة كاملة لمراكز البيانات المعيارية المصغرة والحاوية — مدعوماً بوثائق تقنية وتنسيق التسليم للمشاريع الخارجية.",
    },
    cta: { title: "هل ترغب بالعمل مع فريقنا الهندسي؟", button: "تواصل مع فريق الهندسة" },
  },
  fr: {
    hero: {
      title: "À propos de Haisen",
      subtitle:
    ...
    globalMarkets: {
      ...
      paragraph:
        "Haisen exporte des produits d'infrastructure de centres de données et des solutions de projet vers le Moyen-Orient, l'Afrique, l'Asie du Sud-Est, l'Europe, l'Amérique du Sud et l'Asie centrale, en accompagnant distributeurs, grossistes, entreprises EPC et projets d'utilisateurs finaux directs.",
    },
    engineering: {
      eyebrow: "Support technique",
      title: "Solutions sur mesure et livraison de projets",
      paragraph:
        "Au-delà des produits du catalogue, l'équipe d'ingénierie de Haisen accompagne la configuration spécifique à chaque projet — de la disposition des prises PDU et des dimensions des baies à la conception complète de systèmes de centres de données modulaires micro et conteneurisés — avec documentation technique et coordination de la livraison pour les projets à l'international.",
    },
  ...
  es: {
    ...
    factory: {
      ...
      paragraph:
        "Haisen opera producción directa de fábrica para gabinetes, sistemas de distribución de energía y recintos, con ingeniería interna para el diseño eléctrico, mecánico y térmico. La producción se organiza en torno a especificaciones estándar de catálogo, así como configuraciones específicas de proyecto para pedidos de centros de datos modulares micro y en contenedores.",
    },
    qualityControl: {
      eyebrow: "Garantía",
    ...
    globalMarkets: {
      ...
      paragraph:
        "Haisen exporta productos de infraestructura para centros de datos y soluciones de proyecto a Oriente Medio, África, el Sudeste Asiático, Europa, Sudamérica y Asia Central, apoyando a distribuidores, mayoristas, contratistas EPC y proyectos directos de usuarios finales.",
    },
    engineering: {
      eyebrow: "Soporte de ingeniería",
      title: "Soluciones personalizadas y entrega de proyectos",
      paragraph:
        "Más allá de los productos de catálogo, el equipo de ingeniería de Haisen apoya la configuración específica de cada proyecto — desde la disposición de las tomas del PDU y las dimensiones del gabinete hasta el diseño completo de sistemas de centros de datos modulares micro y en contenedores — respaldado por documentación técnica y coordinación de entrega para proyectos internacionales.",
    },
    cta: { title: "¿Desea trabajar con nuestro equipo de ingeniería?", button: "Contactar al equipo de ingeniería" },
  },
  ru: {
    hero: {
      title: "О компании Haisen",
      subtitle:
    ...
    globalMarkets: {
      ...
      paragraph:
        "Haisen поставляет оборудование для инфраструктуры ЦОД и проектные решения на Ближний Восток, в Африку, Юго-Восточную Азию, Европу, Южную Америку и Центральную Азию, поддерживая дистрибьюторов, оптовых поставщиков, EPC-подрядчиков и прямые проекты конечных заказчиков.",
    },
    engineering: {
      eyebrow: "Инженерная поддержка",
      title: "Индивидуальные решения и реализация проектов",
      paragraph:
        "Помимо каталожной продукции, инженерная команда Haisen поддерживает индивидуальную конфигурацию под конкретный проект — от компоновки розеток PDU и габаритов шкафов до полного проектирования систем микромодульных и контейнерных дата-центров — с технической документацией и координацией поставки для зарубежных проектов.",
    },
  ...
  zh: {
    ...
    overview: {
      ...
      title: "我们是谁",
      paragraph1:
        "海森设计并制造数据中心基础设施与关键电力产品——机柜配电单元(PDU)与智能PDU、UPS系统、网络与服务器机柜、微模块及集装箱数据中心、精密与液冷制冷系统、防静电地板、线缆管理系统以及储能系统。我们直接对接数据中心运营商、电信运营商、系统集成商、EPC总承包商及经销商,既提供标准目录产品,也提供针对具体项目的工程化定制系统。",
      paragraph2:
        "作为工厂直营制造商,海森支持OEM与ODM合作、定制电气与机械规格,并从项目早期设计到调试全程提供工程咨询支持——使海森成为客户全方位的基础设施合作伙伴,而非单一产品供应商。",
      stats: [
        { value: "9", label: "产品类别" },
    ...
    factory: {
      ...
      title: "工厂与生产",
      paragraph:
        "海森为机柜、配电系统及机箱产品提供工厂直营生产,并配备自有电气、机械与热设计工程团队。生产体系既涵盖标准目录规格产品,也支持微模块及集装箱数据中心订单的项目定制化生产。",
    },
    qualityControl: {
      eyebrow: "质量保障",
      title: "质量控制",
    ...
    globalMarkets: {
      ...
      title: "全球市场",
      paragraph:
        "海森的数据中心基础设施产品及项目解决方案已出口至中东、非洲、东南亚、欧洲、南美及中亚地区,服务于经销商、批发商、EPC总承包商及终端客户的直接项目。",
    },
    engineering: {
      eyebrow: "工程支持",
      title: "定制方案与项目交付",
      paragraph:
        "除标准目录产品外,海森工程团队还支持项目专属配置——从PDU出口布局、机柜尺寸,到完整的微模块及集装箱数据中心系统设计——并提供技术文档支持及海外项目交付协调。",
    },
