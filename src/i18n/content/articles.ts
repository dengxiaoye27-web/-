...
export const articleContentTranslations: Record<string, Record<TranslatedLocale, ArticleContent>> = {
  ...
  "metered-vs-switched-pdu": {
    ar: {
      title: "PDU المقاس مقابل PDU القابل للتبديل: ما الفرق؟",
      category: "توزيع الطاقة",
      excerpt: "كيفية التمييز بين وحدات PDU المقاسة والمراقبة والقابلة للتبديل، وأيها يحتاجه راكك فعلياً.",
      readingTime: "4 دقائق قراءة",
      body: [
        { heading: "PDU المقاس", content: "يعرض PDU المقاس التيار و/أو الجهد محلياً، عادة على شاشة LCD أو LED مدمجة، ما يمنح موظفي الموقع قراءة سريعة للحمل دون وصول عن بُعد." },
        { heading: "PDU المراقب", content: "يضيف PDU المراقب اتصالاً بالشبكة، ويبلغ عن التيار والجهد والطاقة وغالباً استهلاك الطاقة عن بُعد — مفيد لتتبع الحمل وPUE دون زيارة الموقع." },
        { heading: "PDU القابل للتبديل", content: "يشمل PDU القابل للتبديل إمكانية المراقبة ويضيف تحكماً عن بُعد بمنافذ قابلة للعنونة الفردية — يمكن للمسؤولين إعادة تشغيل جهاز واحد أو ترتيب تشغيل راك عن بُعد." },
        { heading: "الاختيار بينها", content: "اختر المقاس لرؤية حمل أساسية في الموقع، والمراقب عندما يكون التقرير عن بُعد أهم من التحكم، والقابل للتبديل عند الحاجة لإعادة التشغيل عن بُعد أو بدء تشغيل متسلسل — عادة للمواقع غير المأهولة أو النائية." },
      ],
      faqs: [
        { question: "هل يمكن لـPDU القابل للتبديل أن يقوم بكل ما يقوم به PDU المراقب؟", answer: "نعم — تشمل وحدات PDU القابلة للتبديل وظائف مراقبة PDU المراقب بالإضافة إلى التحكم عن بُعد بالمنافذ، ما يجعلها مجموعة شاملة وليست فئة منفصلة." },
      ],
    },
    fr: {
      title: "PDU mesuré vs PDU commuté : quelle est la différence ?",
      category: "Distribution électrique",
      excerpt: "Comment distinguer les PDU mesurés, surveillés et commutés, et lequel votre rack a réellement besoin.",
      readingTime: "4 min de lecture",
      body: [
        { heading: "PDU mesuré", content: "Un PDU mesuré affiche le courant et/ou la tension localement, généralement sur un écran LCD ou LED intégré, offrant au personnel sur site une lecture rapide de la charge sans accès à distance." },
        { heading: "PDU surveillé", content: "Un PDU surveillé ajoute une connectivité réseau, rapportant à distance le courant, la tension, la puissance et souvent la consommation d'énergie — utile pour suivre la charge et le PUE sans visite sur site." },
        { heading: "PDU commuté", content: "Un PDU commuté inclut la capacité de surveillance et ajoute un contrôle de prise à distance, individuellement adressable — les administrateurs peuvent redémarrer un seul appareil ou séquencer la mise sous tension d'un rack à distance." },
        { heading: "Choisir entre eux", content: "Choisissez le mesuré pour une visibilité de charge de base sur site, le surveillé lorsque le rapport à distance importe plus que le contrôle, et le commuté lorsque le redémarrage à distance ou la mise sous tension séquencée est requis — généralement pour les sites non surveillés ou distants." },
      ],
      faqs: [
        { question: "Un PDU commuté peut-il faire tout ce que fait un PDU surveillé ?", answer: "Oui — les PDU commutés incluent les fonctions de surveillance d'un PDU surveillé plus le contrôle de prise à distance, ce qui en fait un sur-ensemble plutôt qu'une catégorie distincte." },
      ],
    },
    es: {
      title: "PDU medido vs PDU conmutado: ¿cuál es la diferencia?",
      category: "Distribución de energía",
      excerpt: "Cómo distinguir los PDU medidos, monitoreados y conmutados, y cuál necesita realmente su rack.",
      readingTime: "4 min de lectura",
      body: [
        { heading: "PDU medido", content: "Un PDU medido muestra la corriente y/o el voltaje localmente, generalmente en una pantalla LCD o LED integrada, dando al personal en sitio una lectura rápida de la carga sin acceso remoto." },
        { heading: "PDU monitoreado", content: "Un PDU monitoreado añade conectividad de red, informando corriente, voltaje, potencia y a menudo consumo de energía de forma remota; útil para seguir la carga y el PUE sin visitar el sitio." },
        { heading: "PDU conmutado", content: "Un PDU conmutado incluye capacidad de monitoreo y añade control remoto de tomas direccionables individualmente; los administradores pueden reiniciar un solo dispositivo o secuenciar el encendido de un rack de forma remota." },
        { heading: "Elegir entre ellos", content: "Elija medido para visibilidad básica de carga en sitio, monitoreado cuando el reporte remoto importa más que el control, y conmutado cuando se requiere reinicio remoto o encendido secuenciado, típicamente en sitios no atendidos o remotos." },
      ],
      faqs: [
        { question: "¿Puede un PDU conmutado hacer todo lo que hace un PDU monitoreado?", answer: "Sí; los PDU conmutados incluyen las funciones de monitoreo de un PDU monitoreado más el control remoto de tomas, lo que los convierte en un superconjunto en lugar de una categoría separada." },
      ],
    },
    ru: {
      title: "Измерительный PDU и коммутируемый PDU: в чём разница?",
      category: "Распределение питания",
      excerpt: "Как отличить измерительные, контролируемые и коммутируемые PDU, и какой из них действительно нужен вашей стойке.",
      readingTime: "4 мин на чтение",
      body: [
        { heading: "Измерительный PDU", content: "Измерительный PDU отображает ток и/или напряжение локально, обычно на встроенном ЖК- или светодиодном дисплее, давая персоналу на месте быстрое считывание нагрузки без удалённого доступа." },
        { heading: "Контролируемый PDU", content: "Контролируемый PDU добавляет сетевое подключение, удалённо сообщая ток, напряжение, мощность и часто энергопотребление — полезно для отслеживания нагрузки и PUE без выезда на объект." },
        { heading: "Коммутируемый PDU", content: "Коммутируемый PDU включает функции мониторинга и добавляет удалённое, индивидуально адресуемое управление розетками — администраторы могут перезагрузить одно устройство или последовательно включить питание стойки удалённо." },
        { heading: "Выбор между ними", content: "Выбирайте измерительный для базовой видимости нагрузки на месте, контролируемый, когда удалённая отчётность важнее управления, и коммутируемый, когда требуется удалённая перезагрузка или последовательный запуск — обычно для необслуживаемых или удалённых объектов." },
      ],
      faqs: [
        { question: "Может ли коммутируемый PDU делать всё то же, что и контролируемый PDU?", answer: "Да — коммутируемые PDU включают функции мониторинга контролируемого PDU плюс удалённое управление розетками, что делает их надмножеством, а не отдельной категорией." },
      ],
    },
    zh: {
      title: "计量型PDU与可切换型PDU:有何区别？",
      category: "配电",
      excerpt: "如何区分计量型、监控型与可切换型PDU,以及你的机架究竟需要哪一种。",
      readingTime: "4分钟阅读",
      body: [
        { heading: "计量型PDU", content: "计量型PDU通常通过内置LCD或LED显示屏在本地显示电流和/或电压,使现场人员无需远程访问即可快速查看负载情况。" },
        { heading: "监控型PDU", content: "监控型PDU增加了网络连接功能,可远程上报电流、电压、功率及通常包括能耗数据——便于在无需现场查看的情况下跟踪负载及PUE。" },
        { heading: "可切换型PDU", content: "可切换型PDU具备监控能力,并增加了可远程、可单独寻址的插座控制功能——管理员可远程为单台设备断电重启,或按顺序为整个机架上电。" },
        { heading: "如何选择", content: "如仅需现场基础负载查看,选计量型;如远程上报比控制更重要,选监控型;如需要远程断电重启或顺序上电(通常用于无人值守或远程场地),选可切换型。" },
      ],
      faqs: [
        { question: "可切换型PDU能否实现监控型PDU的全部功能？", answer: "可以——可切换型PDU包含监控型PDU的全部监控功能,并额外增加了远程插座控制能力,因此它是监控型的超集,而非独立的类别。" },
      ],
    },
  },
