...
export const productContentTranslations: Record<string, Partial<Record<TranslatedLocale, ProductContent>>> = {
  ...
  "anti-static-raised-floor": {
    ar: {
      ...
      overview: "توفر ألواح الأرضية المرفوعة المضادة للكهرباء الساكنة من واندتونغ سطحاً مرتفعاً ومصنفاً لتحمل الأحمال لتوزيع الهواء تحت الأرضية وتوجيه الكابلات، بسطح PVC مضاد للاستاتيكية (10^6–10^9 أوم) يناسب بيئات مراكز البيانات وغرف الخوادم والمكاتب. يستخدم كل لوح بنية ثلاثية الطبقات — سطح فولاذ SPCC مدرفل على البارد، وقاعدة فولاذية مسحوبة عميقاً، ونواة إسمنتية رغوية عالية الكثافة — مترابطة بنظام قفل زوايا دقيق، على قاعدة فولاذية قابلة لتعديل الارتفاع (100-500 مم).",
      keyFeatures: ["سطح PVC مضاد للاستاتيكية، مقاومة سطحية 10^6–10^9 أوم", "بنية ثلاثية الطبقات: سطح فولاذ SPCC مدرفل على البارد، قاعدة فولاذية مسحوبة عميقاً، نواة إسمنتية رغوية عالية الكثافة", "نظام حافة قفل زوايا دقيق لوصلة محكمة ومستقرة", "قاعدة فولاذية قابلة لتعديل الارتفاع، 100-500 مم", "تركيب سهل بأدوات قليلة", "معتمد CE وISO، متاح OEM/ODM"],
      specGroups: [
        { title: "مواصفات اللوح", specs: [{ label: "حجم اللوح", value: "600 × 600 مم (قياسي)، أحجام مخصصة متاحة" }, { label: "البنية", value: "ثلاثية الطبقات: سطح فولاذي، قاعدة فولاذية مسحوبة عميقاً، نواة إسمنتية رغوية" }, { label: "تصنيف الحمل", value: "800–1200 كجم/م² (يعتمد على الطراز)" }, { label: "مقاومة السطح", value: "10^6–10^9 أوم (مضاد للسكون)" }] },
        { title: "القاعدة والإطار", specs: [{ label: "مادة القاعدة", value: "فولاذ، قابل لتعديل الارتفاع" }, { label: "نطاق الارتفاع", value: "100–500 مم، قابل للتعديل" }, { label: "نظام الحافة", value: "قفل زوايا دقيق" }] },
      ],
      ...
      faqs: [
        ...
        { question: "ما وظيفة نظام قفل الزوايا الدقيق؟", answer: "يربط نظام قفل الزوايا الألواح المتجاورة بحافة دقيقة ومحكمة، ما يحافظ على استقرار سطح الأرضية تحت الأقدام وخلوه من الفجوات التي قد تسمح بتسرب الهواء تحت الأرضية بشكل غير متساوٍ أو تشكل مخاطر تعثر." },
      ],
    },
    fr: {
      ...
      overview: "Les panneaux de plancher surélevé antistatique Wandtung offrent une plateforme élevée et classée pour la charge, destinée à la distribution d'air sous plancher et au cheminement des câbles, avec une surface antistatique en PVC (10^6–10^9 Ω) adaptée aux environnements de centres de données, salles serveurs et bureaux. Chaque panneau utilise une construction à 3 couches — surface en acier SPCC laminé à froid, base en acier emboutie profonde et noyau cimentaire expansé à haute densité — assemblées par un système de verrouillage d'angle de précision, sur un piédestal en acier réglable en hauteur (100-500 mm).",
      keyFeatures: ["Surface antistatique en PVC, résistance de surface 10^6–10^9 Ω", "Construction à 3 couches : surface en acier SPCC laminé à froid, base en acier emboutie profonde, noyau cimentaire expansé à haute densité", "Système de bordure à verrouillage d'angle de précision pour un joint serré et stable", "Piédestal en acier réglable en hauteur, 100-500 mm", "Installation facile, peu d'outils nécessaires", "Certifié CE et ISO, OEM/ODM disponible"],
      specGroups: [
        { title: "Spécification du panneau", specs: [{ label: "Taille du panneau", value: "600 x 600 mm (standard), tailles personnalisées disponibles" }, { label: "Construction", value: "3 couches : surface en acier, base en acier embouti, noyau cimentaire expansé" }, { label: "Classification de charge", value: "800–1200 kg/m² (selon le modèle)" }, { label: "Résistance de surface", value: "10^6–10^9 Ω (antistatique)" }] },
        { title: "Piédestal et cadre", specs: [{ label: "Matériau du piédestal", value: "Acier, réglable en hauteur" }, { label: "Plage de hauteur", value: "100–500 mm, réglable" }, { label: "Système de bordure", value: "Verrouillage d'angle de précision" }] },
      ],
      ...
      faqs: [
        ...
        { question: "À quoi sert le système de verrouillage d'angle de précision ?", answer: "Le système de verrouillage d'angle assemble les panneaux adjacents selon un bord précis et serré, maintenant la surface du plancher stable sous les pieds et exempte d'interstices qui pourraient sinon laisser échapper l'air sous plancher de manière inégale ou créer des risques de trébuchement." },
      ],
    },
    es: {
      ...
      overview: "Los paneles de piso elevado antiestático de Wandtung ofrecen una plataforma elevada y clasificada para carga, destinada a la distribución de aire bajo el piso y el enrutamiento de cables, con una superficie antiestática de PVC (10^6–10^9 Ω) adecuada para entornos de centros de datos, salas de servidores y oficinas. Cada panel utiliza una construcción de 3 capas —superficie de acero SPCC laminado en frío, base de acero embutida profunda y núcleo cementicio expandido de alta densidad— unidas mediante un sistema de bloqueo de esquinas de precisión, sobre un pedestal de acero de altura ajustable (100-500 mm).",
      keyFeatures: ["Superficie antiestática de PVC, resistencia superficial 10^6–10^9 Ω", "Construcción de 3 capas: superficie de acero SPCC laminado en frío, base de acero embutida profunda, núcleo cementicio expandido de alta densidad", "Sistema de borde con bloqueo de esquinas de precisión para una unión ajustada y estable", "Pedestal de acero de altura ajustable, 100-500 mm", "Instalación fácil, con pocas herramientas", "Certificado CE e ISO, OEM/ODM disponible"],
      specGroups: [
        { title: "Especificación del panel", specs: [{ label: "Tamaño del panel", value: "600 x 600 mm (estándar), tamaños personalizados disponibles" }, { label: "Construcción", value: "3 capas: superficie de acero, base de acero embutida, núcleo cementicio expandido" }, { label: "Clasificación de carga", value: "800–1200 kg/m² (según el modelo)" }, { label: "Resistencia superficial", value: "10^6–10^9 Ω (antiestático)" }] },
        { title: "Pedestal y marco", specs: [{ label: "Material del pedestal", value: "Acero, altura ajustable" }, { label: "Rango de altura", value: "100–500 mm, ajustable" }, { label: "Sistema de borde", value: "Bloqueo de esquinas de precisión" }] },
      ],
      ...
      faqs: [
        ...
        { question: "¿Para qué sirve el sistema de bloqueo de esquinas de precisión?", answer: "El sistema de bloqueo de esquinas une los paneles adyacentes con un borde preciso y ajustado, manteniendo la superficie del piso estable al caminar y libre de huecos que de otro modo podrían dejar escapar el aire bajo el piso de forma desigual o crear riesgos de tropiezo." },
      ],
    },
    ru: {
      ...
      overview: "Панели антистатического фальшпола Wandtung обеспечивают приподнятую, рассчитанную на нагрузку платформу для подпольной раздачи воздуха и прокладки кабелей, с антистатическим покрытием из ПВХ (10^6–10^9 Ом), подходящим для ЦОД, серверных и офисных помещений. Каждая панель имеет трёхслойную конструкцию — поверхность из холоднокатаной стали SPCC, глубоко вытянутое стальное основание и высокоплотный вспененный цементный сердечник — соединённые прецизионной угловой системой блокировки, на регулируемой по высоте стальной опоре (100-500 мм).",
      keyFeatures: ["Антистатическое покрытие из ПВХ, поверхностное сопротивление 10^6–10^9 Ом", "Трёхслойная конструкция: поверхность из холоднокатаной стали SPCC, глубоко вытянутое стальное основание, высокоплотный вспененный цементный сердечник", "Прецизионная угловая система блокировки для плотного и стабильного стыка", "Регулируемая по высоте стальная опора, 100-500 мм", "Простой монтаж, минимум инструментов", "Сертификаты CE и ISO, доступен OEM/ODM"],
      specGroups: [
        { title: "Спецификация панели", specs: [{ label: "Размер панели", value: "600 x 600 мм (стандарт), доступны индивидуальные размеры" }, { label: "Конструкция", value: "3 слоя: стальная поверхность, вытянутое стальное основание, вспененный цементный сердечник" }, { label: "Класс нагрузки", value: "800–1200 кг/м² (в зависимости от модели)" }, { label: "Поверхностное сопротивление", value: "10^6–10^9 Ом (антистатическое)" }] },
        { title: "Опора и рама", specs: [{ label: "Материал опоры", value: "Сталь, регулируемая по высоте" }, { label: "Диапазон высоты", value: "100–500 мм, регулируемая" }, { label: "Система стыка", value: "Прецизионная угловая блокировка" }] },
      ],
      ...
      faqs: [
        ...
        { question: "Для чего нужна прецизионная угловая система блокировки?", answer: "Система угловой блокировки соединяет соседние панели по точному, плотному краю, сохраняя устойчивость поверхности пола под ногами и отсутствие зазоров, которые иначе могли бы неравномерно выпускать подпольный воздух или создавать риск спотыкания." },
      ],
    },
    zh: {
      name: "防静电活动地板",
      ...
      overview: "万电通防静电活动地板板材提供架高、具承重等级的地面结构,用于地板下送风及线缆布放,表面采用防静电PVC处理(10^6–10^9 Ω),适用于数据中心、服务器机房及办公环境。每块板材采用三层结构——冷轧SPCC钢材表面、深冲压钢基座及高密度发泡水泥芯——通过精密四角锁定系统连接,搭配高度可调钢制支架(100-500mm)。",
      keyFeatures: ["防静电PVC表面,表面电阻10^6–10^9 Ω", "三层结构:冷轧SPCC钢材表面、深冲压钢基座、高密度发泡水泥芯", "精密四角锁定边缘系统,接缝紧密稳固", "高度可调钢制支架,100-500mm", "安装简便,所需工具少", "通过CE及ISO认证,可提供OEM/ODM"],
      specGroups: [
        { title: "板材规格", specs: [{ label: "板材尺寸", value: "600×600mm(标准),可定制尺寸" }, { label: "结构", value: "三层:钢质表面、深冲压钢基座、发泡水泥芯" }, { label: "承重等级", value: "800–1200 kg/m²(视型号而定)" }, { label: "表面电阻", value: "10^6–10^9 Ω(防静电)" }] },
        { title: "支架与框架", specs: [{ label: "支架材质", value: "钢制,高度可调" }, { label: "高度范围", value: "100–500mm,可调节" }, { label: "边缘系统", value: "精密四角锁定" }] },
      ],
      ...
      faqs: [
        ...
        { question: "精密四角锁定系统有什么作用？", answer: "四角锁定系统将相邻板材以精密紧密的边缘连接,保持地板表面脚感稳固,并消除可能导致地板下方气流不均匀泄漏或绊倒风险的缝隙。" },
      ],
    },
  },
  "glass-raised-floor": {
  ...
  "steel-cementitious-raised-floor": {
    ar: {
      ...
      tagline: "لوح أرضية مرفوعة بسطح HPL مضاد للاستاتيكية ونواة إسمنتية رغوية مغلفة بالفولاذ، بقاعدة معززة بخلية نحل.",
      overview: "تجمع ألواح الأرضية المرفوعة الإسمنتية الفولاذية من واندتونغ بين سطح صفائح ضغط عالٍ (HPL) مضاد للاستاتيكية ونواة إسمنتية رغوية خفيفة الوزن مغلفة بالكامل بغلاف فولاذي عالي الجودة، معززة بهيكل قاعدة فولاذي بخلية نحل ملحوم. يستقر اللوح على نظام قواعد وجسور قابل للتعديل، ما يوفر خياراً فعالاً من حيث التكلفة وواسع الاستخدام للأرضية المرفوعة لأحمال مركز البيانات وغرف المعدات القياسية.",
      keyFeatures: ["سطح صفائح ضغط عالٍ (HPL) مضاد للاستاتيكية", "غلاف فولاذي عالي الجودة يغطي نواة اللوح بالكامل", "نواة إسمنتية رغوية لقوة خفيفة الوزن", "هيكل قاعدة فولاذي بخلية نحل ملحوم لتوزيع الحمل", "فعالة من حيث التكلفة لمتطلبات الحمل القياسية", "تفاوت أبعاد ثابت بين الألواح", "نظام دعم بقواعد وجسور قابل للتعديل"],
      specGroups: [{ title: "مواصفات اللوح", specs: [{ label: "حجم اللوح", value: "600 × 600 مم" }, { label: "السطح", value: "صفائح ضغط عالٍ (HPL) مضادة للاستاتيكية" }, { label: "مادة النواة", value: "إسمنتية رغوية، مغلفة بالفولاذ" }, { label: "هيكل القاعدة", value: "فولاذ بخلية نحل ملحوم" }, { label: "تصنيف الحمل", value: "حتى 900 كجم حمل مركز (يعتمد على الطراز)" }] }],
      ...
      faqs: [
        ...
        { question: "ما وظيفة هيكل القاعدة الفولاذي بخلية النحل؟", answer: "يوزع هيكل القاعدة الفولاذي الملحوم بخلية النحل تحت النواة الإسمنتية أحمال النقاط المركزة بالتساوي عبر اللوح وقواعد الدعم، ما يضيف صلابة دون زيادة وزن اللوح بشكل كبير." },
      ],
    },
    fr: {
      name: "Plancher surélevé cimentaire gainé d'acier",
      shortName: "Plancher cimentaire acier",
      tagline: "Panneau de plancher surélevé à surface HPL antistatique et noyau cimentaire expansé gainé d'acier, base renforcée en nid d'abeille.",
      overview: "Les panneaux de plancher surélevé cimentaire gainé d'acier Wandtung associent une surface antistatique en stratifié haute pression (HPL) à un noyau cimentaire expansé léger entièrement gainé d'une coque en acier de haute qualité, renforcé par une structure de base en acier en nid d'abeille soudée. Le panneau repose sur un système de piédestal et de traverse réglable, offrant une option de plancher surélevé rentable et largement utilisée pour les charges standard de centres de données et de salles d'équipement.",
      keyFeatures: ["Surface antistatique en stratifié haute pression (HPL)", "Coque en acier de haute qualité gainant entièrement le noyau du panneau", "Noyau cimentaire expansé pour une résistance légère", "Structure de base en acier en nid d'abeille soudée pour la répartition des charges", "Rentable pour les exigences de charge standard", "Tolérance dimensionnelle constante d'un panneau à l'autre", "Système de support à piédestal et traverse réglable"],
      specGroups: [{ title: "Spécification du panneau", specs: [{ label: "Taille du panneau", value: "600 x 600 mm" }, { label: "Surface", value: "Stratifié HPL antistatique" }, { label: "Matériau du noyau", value: "Cimentaire expansé, gainé d'acier" }, { label: "Structure de base", value: "Acier en nid d'abeille soudé" }, { label: "Classification de charge", value: "Jusqu'à 900 kg de charge concentrée (selon le modèle)" }] }],
      ...
      faqs: [
        ...
        { question: "À quoi sert la structure de base en acier en nid d'abeille ?", answer: "La base en acier en nid d'abeille soudée sous le noyau cimentaire répartit uniformément les charges ponctuelles concentrées sur le panneau et les supports de piédestal, ajoutant de la rigidité sans augmenter significativement le poids du panneau." },
      ],
    },
    es: {
      name: "Piso elevado cementicio revestido de acero",
      shortName: "Piso cementicio de acero",
      tagline: "Panel de piso elevado con superficie HPL antiestática y núcleo cementicio expandido revestido de acero, base reforzada en panal de abeja.",
      overview: "Los paneles de piso elevado cementicio revestido de acero de Wandtung combinan una superficie antiestática de laminado de alta presión (HPL) con un núcleo cementicio expandido ligero completamente revestido en una carcasa de acero de alta calidad, reforzado por una estructura de base de acero en panal de abeja soldada. El panel se apoya sobre un sistema de pedestal y larguero ajustable, ofreciendo una opción de piso elevado rentable y ampliamente utilizada para cargas estándar de centros de datos y salas de equipos.",
      keyFeatures: ["Superficie antiestática de laminado de alta presión (HPL)", "Carcasa de acero de alta calidad que reviste completamente el núcleo del panel", "Núcleo cementicio expandido para resistencia ligera", "Estructura de base de acero en panal de abeja soldada para distribución de carga", "Rentable para requisitos de carga estándar", "Tolerancia dimensional consistente entre paneles", "Sistema de soporte de pedestal y larguero ajustable"],
      specGroups: [{ title: "Especificación del panel", specs: [{ label: "Tamaño del panel", value: "600 x 600 mm" }, { label: "Superficie", value: "Laminado HPL antiestático" }, { label: "Material del núcleo", value: "Cementicio expandido, revestido de acero" }, { label: "Estructura de base", value: "Acero en panal de abeja soldado" }, { label: "Clasificación de carga", value: "Hasta 900 kg de carga concentrada (según el modelo)" }] }],
      ...
      faqs: [
        ...
        { question: "¿Qué función cumple la estructura de base de acero en panal de abeja?", answer: "La base de acero en panal de abeja soldada bajo el núcleo cementicio distribuye uniformemente las cargas puntuales concentradas por el panel y los soportes de pedestal, añadiendo rigidez sin aumentar significativamente el peso del panel." },
      ],
    },
    ru: {
      name: "Цементный фальшпол в стальной оболочке",
      shortName: "Цементный фальшпол",
      tagline: "Панель фальшпола с антистатическим покрытием HPL и вспененным цементным сердечником в стальной оболочке, усиленное сотовое стальное основание.",
      overview: "Панели цементного фальшпола Wandtung в стальной оболочке сочетают антистатическое покрытие из слоистого пластика высокого давления (HPL) с лёгким вспененным цементным сердечником, полностью заключённым в оболочку из высококачественной стали, усиленную сварной сотовой стальной основой. Панель устанавливается на регулируемую систему опор и лаг, обеспечивая экономичный, широко используемый вариант фальшпола для стандартных нагрузок ЦОД и помещений с оборудованием.",
      keyFeatures: ["Антистатическое покрытие из слоистого пластика высокого давления (HPL)", "Оболочка из высококачественной стали, полностью закрывающая сердечник панели", "Внутренний вспененный цементный сердечник для лёгкой прочности", "Сварная сотовая стальная основа для распределения нагрузки", "Экономичность для стандартных требований по нагрузке", "Стабильный допуск размеров между панелями", "Регулируемая система опор и лаг"],
      specGroups: [{ title: "Спецификация панели", specs: [{ label: "Размер панели", value: "600 x 600 мм" }, { label: "Покрытие", value: "Антистатический слоистый пластик HPL" }, { label: "Материал сердечника", value: "Вспененный цемент, в стальной оболочке" }, { label: "Структура основы", value: "Сварная сотовая сталь" }, { label: "Класс нагрузки", value: "До 900 кг сосредоточенной нагрузки (в зависимости от модели)" }] }],
      ...
      faqs: [
        ...
        { question: "Для чего нужна сотовая стальная структура основы?", answer: "Сварная сотовая стальная основа под цементным сердечником равномерно распределяет сосредоточенные точечные нагрузки по панели и опорам, повышая жёсткость без значительного увеличения веса панели." },
      ],
    },
    zh: {
      name: "钢包边水泥基活动地板",
      shortName: "钢包边水泥地板",
      tagline: "HPL防静电表面、钢包边发泡水泥芯活动地板，蜂窝钢结构加固基座。",
      overview: "万电通钢包边水泥基活动地板板材将高压层压板(HPL)防静电表面与轻质发泡水泥芯材相结合，芯材完全包覆于高品质钢壳内，并由焊接蜂窝钢基座结构加固。板材安装于可调支架及龙骨系统上，是适用于数据中心及设备间标准载荷、经济高效且广泛使用的活动地板方案。",
      keyFeatures: ["高压层压板(HPL)防静电表面", "高品质钢壳完全包覆板材芯材", "内部发泡水泥芯材,轻质高强度", "焊接蜂窝钢基座结构实现均匀承重", "满足标准承重需求,经济高效", "板材间尺寸公差一致", "可调支架及龙骨支撑系统"],
      specGroups: [{ title: "板材规格", specs: [{ label: "板材尺寸", value: "600×600mm" }, { label: "表面", value: "HPL防静电层压板" }, { label: "芯材", value: "发泡水泥,钢包边" }, { label: "基座结构", value: "焊接蜂窝钢" }, { label: "承重等级", value: "最高900kg集中载荷(视型号而定)" }] }],
      ...
      faqs: [
        ...
        { question: "蜂窝钢基座结构有什么作用？", answer: "水泥芯材下方的焊接蜂窝钢基座可将集中点载荷均匀分布至板材及支架支撑上,在不显著增加板材重量的前提下提升整体刚性。" },
      ],
    },
  },
  "airflow-floor": {
