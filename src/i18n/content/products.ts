...
export const productContentTranslations: Record<string, Partial<Record<TranslatedLocale, ProductContent>>> = {
  ...
  "high-power-ups": {
    ar: {
      ...
      overview: "يوفر UPS عالي الطاقة من واندتونغ حماية مزدوجة التحويل ثلاثية الطور بسعة كبيرة لقاعات البيانات الكاملة والأحمال الحرجة على مستوى المنشأة، متوفر في إطارات قائمة بذاتها أو كلبنة بناء لمحطة طاقة معيارية متوازية التكرار.",
    ...
    es: {
      ...
      overview: "El SAI de alta potencia de Wandtung ofrece protección trifásica de doble conversión de gran capacidad para salas de datos completas y cargas críticas a nivel de instalación, disponible en chasis independientes o como bloque de construcción para una planta de energía modular con redundancia paralela.",
    ...
    ru: {
      ...
      overview: "Мощный ИБП Wandtung обеспечивает трёхфазную защиту двойного преобразования большой мощности для целых машинных залов и критических нагрузок уровня объекта, доступен в отдельных шасси или как элемент модульной параллельно-резервированной энергетической установки.",
    ...
    zh: {
      ...
      overview: "万电通大功率UPS为完整机房及设施级关键负载提供大容量三相双转换保护,提供独立机架形式,也可作为模块化并联冗余电力系统的构建单元。",
