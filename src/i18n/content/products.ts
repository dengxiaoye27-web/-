...
export const productContentTranslations: Record<string, Partial<Record<TranslatedLocale, ProductContent>>> = {
  ...
  "precision-air-conditioner": {
    ar: {
      ...
      overview: "يوفر مكيف الهواء الدقيق من هايسِن تحكماً محكماً بدرجة الحرارة والرطوبة لقاعات البيانات وغرف الاتصالات، مع توزيع هواء بتدفق سفلي أو علوي وسعات تناسب غرف المعدات الصغيرة وحتى المساحة البيضاء الكبيرة لمركز البيانات.",
    ...
    es: {
      ...
      overview: "El aire acondicionado de precisión de Haisen proporciona un control estricto de la temperatura y la humedad para salas de datos y salas de telecomunicaciones, con distribución de aire de flujo descendente o ascendente y capacidades adecuadas desde pequeñas salas de equipos hasta grandes espacios blancos de centros de datos.",
    ...
    ru: {
      ...
      overview: "Прецизионный кондиционер Haisen обеспечивает точный контроль температуры и влажности для машинных залов и телекоммуникационных помещений, с нижней или верхней раздачей воздуха и мощностью, подходящей от небольших технических помещений до крупных машинных залов ЦОД.",
    ...
    zh: {
      ...
      overview: "海森精密空调为机房及电信设备间提供严格的温湿度控制,支持下送风或上送风气流分配方式,容量覆盖从小型设备间到大型数据中心白空间的多种应用场景。",
  ...
  "liquid-cooling": {
    ar: {
      ...
      overview: "يجمع حل التبريد السائل من هايسِن بين التبريد السائل بلوحة باردة على مستوى الخادم ووحدة توزيع مبرد (CDU) تدير الحلقتين الأساسية والثانوية، ما يتيح لمراكز البيانات تبريد راكات تدريب الذكاء الاصطناعي والحوسبة عالية الأداء فائقة الكثافة بما يتجاوز حدود التبريد الهوائي العملية.",
    ...
    fr: {
      ...
      overview: "La solution de refroidissement liquide de Haisen combine le refroidissement liquide à plaque froide au niveau du serveur avec une unité de distribution de liquide de refroidissement (CDU) gérant les boucles primaire et secondaire, permettant aux centres de données de refroidir les racks d'entraînement IA et HPC à haute densité au-delà des limites pratiques du refroidissement par air.",
    ...
    ru: {
      ...
      overview: "Решение жидкостного охлаждения Haisen сочетает жидкостное охлаждение холодными пластинами на уровне сервера с блоком распределения хладагента (CDU), управляющим первичным и вторичным контурами, что позволяет ЦОД охлаждать стойки для обучения ИИ и HPC высокой плотности за пределами практических возможностей воздушного охлаждения.",
    ...
    zh: {
      ...
      overview: "海森液冷解决方案将服务器级冷板液冷与管理一次侧及二次侧回路的冷却液分配单元(CDU)相结合,使数据中心能够为高密度AI训练及HPC机架提供超越风冷实际极限的制冷能力。",
  ...
  cdu: {
    ar: {
      ...
      overview: "تدير CDU من هايسِن توزيع المبرد بين حلقة المنشأة (الأساسية) وحلقة مستوى الراك (الثانوية) في نشر التبريد السائل، وتوفر الضخ وتبادل الحرارة والترشيح وكشف التسرب والمراقبة في وحدة واحدة قابلة للتركيب بالراك أو قائمة بذاتها.",
    ...
    fr: {
      ...
      overview: "La CDU Haisen gère la distribution du liquide de refroidissement entre la boucle de l'installation (primaire) et la boucle au niveau du rack (secondaire) dans un déploiement de refroidissement liquide, fournissant pompage, échange de chaleur, filtration, détection de fuite et surveillance dans une unité unique montable en rack ou autonome.",
    ...
    es: {
      ...
      overview: "La CDU de Haisen gestiona la distribución del refrigerante entre el circuito de la instalación (primario) y el circuito a nivel de rack (secundario) en un despliegue de refrigeración líquida, proporcionando bombeo, intercambio de calor, filtración, detección de fugas y monitoreo en una única unidad montable en rack o independiente.",
    ...
    ru: {
      ...
      overview: "CDU Haisen управляет распределением хладагента между контуром объекта (первичным) и контуром на уровне стойки (вторичным) в развёртывании жидкостного охлаждения, обеспечивая перекачку, теплообмен, фильтрацию, обнаружение утечек и мониторинг в единой стоечной или автономной установке.",
    ...
    zh: {
      ...
      overview: "海森CDU在液冷部署中管理设施(一次侧)回路与机架级(二次侧)回路之间的冷却液分配,在单一机架式或独立式设备中集成泵送、热交换、过滤、漏液检测及监控功能。",
  ...
  "row-based-cooling": {
    ar: {
      ...
      overview: "يضع التبريد على مستوى الصف من هايسِن سعة التبريد ضمن صف خزانات تكنولوجيا المعلومات بدلاً من حول محيط الغرفة، ما يقصّر مسار تدفق الهواء إلى الحمل ويحسّن كفاءة التبريد وقابليته للتنبؤ عند كثافات راك متوسطة إلى عالية.",
      ...
      standards: ["الشهادة متاحة عند الطلب حسب مواصفات المشروع"],
      faqs: [
        { question: "ما الفرق بين التبريد على مستوى الصف والتبريد داخل الصف؟", answer: "المصطلحان قابلان للتبادل إلى حد كبير في الصناعة — يصف كلاهما وحدات التبريد الموضوعة ضمن صف الخزانات بدلاً من حول محيط الغرفة. تستخدم هايسِن \"على مستوى الصف\" للفئة الأوسع و\"داخل الصف\" للوحدات الموضوعة مباشرة بين الخزانات في الصف." },
      ],
    },
    fr: {
    ...
    es: {
      ...
      overview: "La refrigeración a nivel de fila de Haisen coloca la capacidad de refrigeración dentro de la fila de armarios de TI en lugar de alrededor del perímetro de la sala, acortando la ruta de flujo de aire hacia la carga y mejorando la eficiencia y previsibilidad de la refrigeración a densidades de rack media a alta.",
      ...
      standards: ["Certificación disponible bajo pedido según la especificación del proyecto"],
      faqs: [
        { question: "¿Cuál es la diferencia entre refrigeración a nivel de fila y refrigeración in-row?", answer: "Los términos son en gran medida intercambiables en la industria: ambos describen unidades de refrigeración colocadas dentro de la fila de armarios en lugar de alrededor del perímetro de la sala. Haisen usa 'a nivel de fila' para la categoría más amplia e 'in-row' para las unidades que se sitúan directamente entre los armarios de la fila." },
      ],
    },
    ru: {
      ...
      overview: "Рядное охлаждение Haisen размещает мощность охлаждения внутри ряда ИТ-шкафов, а не по периметру помещения, сокращая путь воздушного потока к нагрузке и повышая эффективность и предсказуемость охлаждения при средней и высокой плотности стоек.",
      ...
      standards: ["Сертификация доступна по запросу в соответствии со спецификацией проекта"],
      faqs: [
        { question: "В чём разница между рядным и внутрирядным охлаждением?", answer: "Эти термины в отрасли во многом взаимозаменяемы — оба описывают блоки охлаждения, расположенные внутри ряда шкафов, а не по периметру помещения. Haisen использует «рядное» для более широкой категории и «внутрирядное» для блоков, расположенных непосредственно между шкафами в ряду." },
      ],
    },
    zh: {
      name: "行级制冷",
      ...
      overview: "海森行级制冷将制冷能力布置于IT机柜排列内部,而非沿房间四周,从而缩短气流到达负载的路径,在中高密度机架场景下提升制冷效率与可预测性。",
      ...
      standards: ["认证可根据项目规格按需提供"],
      faqs: [
        { question: "行级制冷与列间制冷有何区别？", answer: "这两个术语在行业内基本可互换使用——均指将制冷单元布置于机柜排列内部而非房间四周。海森使用“行级”指代更广泛的类别,“列间”则特指直接安装于同排机柜之间的制冷单元。" },
      ],
    },
  },
  "in-row-cooling": {
    ar: {
      ...
      overview: "تُركَّب وحدات التبريد داخل الصف من هايسِن مباشرة ضمن صف الخزانات — بنفس مساحة خزانة تكنولوجيا المعلومات — ما يضع سعة التبريد بجوار الراكات المولّدة للحرارة مباشرة، لتحكم محكم وقابل للتنبؤ بدرجة الحرارة على مستوى الصف.",
    ...
    ru: {
      ...
      overview: "Блоки внутрирядного охлаждения Haisen устанавливаются непосредственно внутри ряда шкафов — с той же площадью, что и ИТ-шкаф, — размещая мощность охлаждения непосредственно рядом со стойками, выделяющими тепло, для жёсткого и предсказуемого контроля температуры на уровне ряда.",
    ...
    zh: {
      ...
      overview: "海森列间制冷单元直接安装于机柜排列内——与IT机柜占地相同——将制冷能力紧邻产热机架布置,实现行级紧密、可预测的温度控制。",
  ...
  "room-cooling": {
    ar: {
      ...
      overview: "تُكيّف وحدات تبريد الغرفة من هايسِن قاعة البيانات أو غرفة المعدات بأكملها من محيط الغرفة — النهج التقليدي لتبريد مركز البيانات، المناسب جيداً للغرف الأقل كثافة أو كطبقة أساسية إلى جانب التبريد على مستوى الصف/داخل الصف عند الكثافات الأعلى.",
    ...
    fr: {
      ...
      overview: "Les unités de refroidissement de pièce Haisen conditionnent toute la salle informatique ou la salle d'équipement depuis le périmètre de la pièce — l'approche traditionnelle de refroidissement des centres de données, bien adaptée aux pièces à densité plus faible ou comme couche de référence aux côtés du refroidissement de rangée/in-row à des densités plus élevées.",
    ...
    es: {
      ...
      overview: "Las unidades de refrigeración de sala de Haisen acondicionan toda la sala de datos o sala de equipos desde el perímetro de la sala; el enfoque tradicional de refrigeración de centros de datos, muy adecuado para salas de menor densidad o como capa base junto con la refrigeración a nivel de fila/in-row en densidades más altas.",
    ...
    zh: {
      ...
      overview: "海森房间制冷机组从房间四周对整个机房或设备间进行制冷调节——这是传统的数据中心制冷方式,非常适合低密度机房,或在高密度场景下作为行级/列间制冷的基础层配合使用。",
  ...
  "anti-static-raised-floor": {
    ar: {
      ...
      overview: "توفر ألواح الأرضية المرفوعة المضادة للكهرباء الساكنة من هايسِن سطحاً مرتفعاً ومصنفاً لتحمل الأحمال لتوزيع الهواء تحت الأرضية وتوجيه الكابلات، مع تشطيب سطحي مبدد للسكون يناسب بيئات مركز البيانات وغرف التحكم.",
    ...
    fr: {
      ...
      overview: "Les panneaux de plancher surélevé antistatique Haisen offrent une plateforme élevée et classée pour la charge, destinée à la distribution d'air sous plancher et au cheminement des câbles, avec une finition de surface dissipatrice d'électricité statique adaptée aux environnements de centres de données et de salles de contrôle.",
    ...
    ru: {
      ...
      overview: "Панели антистатического фальшпола Haisen обеспечивают приподнятую, рассчитанную на нагрузку платформу для подпольной раздачи воздуха и прокладки кабелей, с антистатическим покрытием поверхности, подходящим для сред ЦОД и диспетчерских.",
    ...
    zh: {
      ...
      overview: "海森防静电活动地板板材提供架高、具承重等级的地面结构,用于地板下送风及线缆布放,表面采用防静电耗散处理,适用于数据中心及控制室环境。",
  ...
  "calcium-sulphate-raised-floor": {
    ar: {
      ...
      overview: "تستخدم ألواح الأرضية المرفوعة بكبريتات الكالسيوم من هايسِن نواة كثيفة من كبريتات الكالسيوم لسعة حمل عالية واستقرار أبعاد، مناسبة لقاعات البيانات وغرف المعدات ذات الأحمال النقطية الثقيلة أو متطلبات تصنيف الحريق التي تتجاوز اللوح القياسي المغلف بالفولاذ.",
    ...
    es: {
      ...
      overview: "Los paneles de piso elevado de sulfato de calcio de Haisen utilizan un núcleo denso de sulfato de calcio para una alta capacidad de carga y estabilidad dimensional, adecuados para salas de datos y salas de equipos con cargas puntuales pesadas o requisitos de clasificación contra incendios más allá de un panel estándar revestido de acero.",
    ...
    zh: {
      ...
      overview: "海森硫酸钙活动地板板材采用高密度硫酸钙芯材,具备高承重能力及尺寸稳定性,适用于对点载荷承重或防火等级要求超出标准钢包边板材的机房及设备间。",
  ...
  "steel-cementitious-raised-floor": {
    ar: {
      ...
      overview: "تستخدم ألواح الأرضية المرفوعة الإسمنتية الفولاذية من هايسِن نواة إسمنتية خفيفة الوزن مغلفة بالكامل بالفولاذ المجلفن، ما يوفر خياراً فعالاً من حيث التكلفة وواسع الاستخدام للأرضية المرفوعة لأحمال مركز البيانات وغرف المعدات القياسية.",
    ...
    fr: {
      ...
      overview: "Les panneaux de plancher surélevé cimentaire gainé d'acier Haisen utilisent un noyau cimentaire léger entièrement gainé d'acier galvanisé, offrant une option de plancher surélevé rentable et largement utilisée pour les charges standard de centres de données et de salles d'équipement.",
    ...
    es: {
      ...
      overview: "Los paneles de piso elevado cementicio revestido de acero de Haisen utilizan un núcleo cementicio ligero completamente revestido de acero galvanizado, ofreciendo una opción de piso elevado rentable y ampliamente utilizada para cargas estándar de centros de datos y salas de equipos.",
    ...
    ru: {
      ...
      overview: "Панели цементного фальшпола Haisen в стальной оболочке используют лёгкий цементный сердечник, полностью заключённый в оцинкованную сталь, обеспечивая экономичный, широко используемый вариант фальшпола для стандартных нагрузок ЦОД и помещений с оборудованием.",
    ...
    zh: {
      ...
      overview: "海森钢包边水泥基活动地板板材采用轻质水泥芯材,完全包覆镀锌钢板,是适用于数据中心及设备间标准载荷、经济高效且广泛使用的活动地板方案。",
  ...
  "airflow-floor": {
    ar: {
      ...
      overview: "ألواح أرضية تدفق الهواء من هايسِن هي بلاطات أرضية مرفوعة مثقبة مصممة لتوصيل حجم متحكم به من الهواء البارد تحت الأرضية إلى الممر البارد، مع خيارات فتحات قابلة للتعديل أو ثابتة لموازنة تدفق الهواء عبر قاعة البيانات.",
    ...
    fr: {
      ...
      overview: "Les panneaux de plancher de flux d'air Haisen sont des dalles de plancher surélevé perforées conçues pour délivrer un volume contrôlé d'air froid sous plancher dans l'allée froide, avec des options d'ouverture réglable ou fixe pour équilibrer le flux d'air dans la salle informatique.",
    ...
    es: {
      ...
      overview: "Los paneles de piso de flujo de aire de Haisen son losetas de piso elevado perforadas diseñadas para entregar un volumen controlado de aire frío bajo el piso al pasillo frío, con opciones de amortiguador ajustable o fijo para equilibrar el flujo de aire en toda la sala de datos.",
    ...
    zh: {
      ...
      overview: "海森通风地板板材是经过工程设计的穿孔活动地板砖,用于向冷通道输送受控风量的地板下冷空气,提供可调节或固定开孔率选项,以平衡机房内的气流分布。",
  ...
  "cable-tray": {
    ar: {
      ...
      overview: "توفر مجاري الكابلات من هايسِن مسارات منظمة وقابلة للصيانة لكابلات الطاقة والبيانات فوق الراكات أو تحت الأرضية المرفوعة، متوفرة بإنشاء شبكي سلكي ونوع سلمي لمتطلبات حمل وملء كابلات مختلفة.",
    ...
    es: {
      ...
      overview: "Las bandejas de cables de Haisen ofrecen rutas estructuradas y accesibles para el cableado de energía y datos sobre los racks o bajo pisos elevados, disponibles en construcción de malla metálica y tipo escalera para diferentes requisitos de carga y llenado de cables.",
    ...
    ru: {
      ...
      overview: "Кабельные лотки Haisen обеспечивают структурированные, обслуживаемые трассы для силовых и информационных кабелей над стойками или под фальшполом, доступны в сетчатой и лестничной конструкции для различных требований к нагрузке и заполнению кабелями.",
    ...
    zh: {
      ...
      overview: "海森电缆桥架为机架上方或活动地板下方的电力及数据线缆提供结构化、可维护的路径,提供网格式及梯式两种结构,满足不同承重及线缆填充需求。",
  ...
  "wire-mesh-cable-tray": {
    ar: {
      ...
      overview: "مجرى الكابلات الشبكي السلكي من هايسِن هو إنشاء سلكي ملحوم خفيف الوزن ومهوّى وسهل القطع وإعادة التكوين في الموقع، ما يجعله خياراً شائعاً لمسارات كابلات البيانات والألياف المنظمة فوق الراكات أو على طول مسارات الاحتواء.",
    ...
    fr: {
      ...
      overview: "Le chemin de câbles grillagé Haisen est une construction en fil soudé légère, ventilée et facile à couper et reconfigurer sur site, ce qui en fait un choix courant pour les cheminements de câbles de données et de fibre structurés au-dessus des racks ou le long des routes de confinement.",
    ...
    es: {
      ...
      overview: "La bandeja de cables de malla metálica de Haisen es una construcción de alambre soldado liviana, ventilada y fácil de cortar y reconfigurar en sitio, lo que la convierte en una opción común para rutas de cableado de datos y fibra estructurado sobre racks o a lo largo de rutas de contención.",
    ...
    ru: {
      ...
      overview: "Сетчатый кабельный лоток Haisen — это сварная проволочная конструкция, лёгкая, вентилируемая и легко режущаяся и переконфигурируемая на месте, что делает его распространённым выбором для структурированных трасс данных и оптоволокна над стойками или вдоль маршрутов изоляции.",
    ...
    zh: {
      ...
      overview: "海森网格式电缆桥架采用焊接钢丝结构,重量轻、通风性好,便于现场切割及重新配置,是机架上方或封闭通道沿线结构化数据及光纤布线的常见选择。",
  ...
  "ladder-cable-tray": {
    ar: {
      ...
      overview: "يستخدم مجرى الكابلات السلمي من هايسِن إنشاء درجات وقضبان مصنف لملء وسعة حمل كابلات أعلى من الشبكي السلكي، مع تبديد حراري جيد لمسارات كابلات الطاقة الأثقل عبر مراكز البيانات وغرف الاتصالات والمنشآت الصناعية.",
    ...
    zh: {
      ...
      overview: "海森梯式电缆桥架采用横档与侧梁结构,相比网格式桥架具备更高的线缆填充率及承重能力,为数据中心、电信机房及工业设施中较重的电力线缆路径提供良好的散热性能。",
  ...
  "battery-energy-storage-system": {
    ar: {
      ...
      overview: "يدمج نظام تخزين طاقة البطارية من هايسِن راكات البطارية ونظام تحويل الطاقة (PCS) ونظام إدارة الطاقة (EMS) في أشكال خزانة أو حاوية، ويدعم قص الذروة والطاقة الاحتياطية ودمج الطاقة المتجددة لمراكز البيانات والمواقع الصناعية.",
    ...
    zh: {
      ...
      overview: "海森电池储能系统将电池组、功率变换系统(PCS)及能量管理系统(EMS)集成于机柜式或集装箱式形态中,支持削峰填谷、备用电力及可再生能源接入,适用于数据中心及工业场地。",
  ...
  "solar-power-system": {
    ar: {
      ...
      overview: "يجمع نظام الطاقة الشمسية من هايسِن توليد الطاقة الكهروضوئية مع عاكسات، وحيثما لزم، تخزين البطارية لتزويد طاقة الموقع لتعويض متصل بالشبكة أو تشغيل خارج الشبكة — مصمم للأحمال المساعدة لمركز البيانات ومواقع الاتصالات والمنشآت الصناعية الساعية لتقليل الاعتماد على الشبكة.",
    ...
    es: {
      ...
      overview: "El sistema de energía solar de Haisen combina generación fotovoltaica con inversores y, cuando es necesario, almacenamiento en batería para suministrar energía del sitio para compensación conectada a la red u operación fuera de red; dimensionado para cargas auxiliares de centros de datos, sitios de telecomunicaciones e instalaciones industriales que buscan reducir la dependencia de la red.",
    ...
    zh: {
      ...
      overview: "海森太阳能发电系统将光伏发电与逆变器相结合,并在需要时配备电池储能,以并网抵消或离网运行方式为场地供电——适用于希望降低电网依赖的数据中心辅助负载、电信站点及工业设施。",
  ...
  "energy-storage-system": {
    ar: {
      ...
      overview: "نظام تخزين الطاقة (ESS) من هايسِن هو اللبنة العامة وراء منتجات تخزين الطاقة بالخزائن والحاويات من هايسِن — راكات بطارية ونظام تحويل طاقة (PCS) ونظام إدارة طاقة (EMS) مُهيّأة حسب سعة الموقع واستراتيجية التشغيل، سواء كانت طاقة احتياطية أو قص ذروة أو دمج متجددة.",
      ...
      standards: ["الشهادة متاحة عند الطلب حسب مواصفات المشروع"],
      faqs: [
        { question: "ما الفرق بين ESS وBESS؟", answer: "يشير BESS (نظام تخزين طاقة البطارية) تحديداً إلى التخزين القائم على البطارية. ESS (نظام تخزين الطاقة) هو المصطلح الأوسع للنظام الكلي — البطارية وPCS وEMS — الذي تُهيّئه هايسِن لموقع معين؛ في الممارسة العملية، غالباً ما يُستخدم المصطلحان بالتبادل لعمليات النشر القائمة على البطارية." },
      ],
    },
    fr: {
      ...
      overview: "Le système de stockage d'énergie (ESS) Haisen est l'élément constitutif général derrière les produits de stockage d'énergie en armoire et conteneurisés de Haisen — racks de batteries, système de conversion de puissance (PCS) et système de gestion d'énergie (EMS) configurés selon la capacité et la stratégie opérationnelle du site, qu'il s'agisse d'alimentation de secours, d'écrêtage de pointe ou d'intégration renouvelable.",
    ...
    es: {
      ...
      overview: "El sistema de almacenamiento de energía (ESS) de Haisen es el bloque de construcción general detrás de los productos de almacenamiento de energía en armario y contenedor de Haisen: racks de baterías, un sistema de conversión de energía (PCS) y un sistema de gestión de energía (EMS) configurados según la capacidad y estrategia operativa del sitio, ya sea energía de respaldo, recorte de picos o integración renovable.",
    ...
    ru: {
      ...
      overview: "Система накопления энергии (ESS) Haisen — это общий строительный блок для шкафных и контейнерных продуктов накопления энергии Haisen: стойки батарей, система преобразования мощности (PCS) и система управления энергией (EMS), настраиваемые под мощность и операционную стратегию объекта — будь то резервное питание, сглаживание пиков или интеграция возобновляемой энергии.",
      ...
      standards: ["Сертификация доступна по запросу в соответствии со спецификацией проекта"],
      faqs: [
        { question: "В чём разница между ESS и BESS?", answer: "BESS (система накопления энергии на батареях) конкретно относится к накоплению на основе батарей. ESS (система накопления энергии) — более широкий термин для общей системы — батареи, PCS и EMS, — которую Haisen настраивает для конкретного объекта; на практике эти термины часто используются взаимозаменяемо для развёртываний на основе батарей." },
      ],
    },
    zh: {
      name: "储能系统(ESS)",
      ...
      overview: "海森储能系统(ESS)是海森机柜式及集装箱式储能产品背后的通用构建模块——电池组、功率变换系统(PCS)及能量管理系统(EMS)可根据场地容量及运行策略进行配置,无论是用于备用电力、削峰还是可再生能源接入。",
      ...
      standards: ["认证可根据项目规格按需提供"],
      faqs: [
        { question: "ESS与BESS有何区别？", answer: "BESS(电池储能系统)特指基于电池的储能方式。ESS(储能系统)则是海森为特定场地配置的整体系统——电池、PCS及EMS——的更广泛术语;实际应用中,这两个术语在基于电池的部署场景下常可互换使用。" },
      ],
    },
  },
  "energy-storage-cabinet": {
    ar: {
      ...
      overview: "تعبّئ خزانة تخزين الطاقة من هايسِن راكات البطارية وPCS وEMS في مساحة خزانة قياسية للتركيب الداخلي أو في مساحة محمية، مناسبة للمواقع التي لديها مساحة غرفة معدات متاحة لكن لا تتطلب وحدة حاوية خارجية كاملة.",
    ...
    ru: {
      ...
      overview: "Шкаф накопления энергии Haisen объединяет стойки батарей, PCS и EMS в габаритах стандартного шкафа для установки в помещении или защищённом пространстве, подходит для объектов с доступным пространством в техническом помещении, не требующих полноценного наружного контейнерного блока.",
    ...
    zh: {
      ...
      overview: "海森储能机柜将电池组、PCS及EMS集成于标准机柜占地内,适用于室内或受保护空间安装,适合具备设备间空间但无需完整户外集装箱式设备的场地。",
  ...
  "containerized-energy-storage-system": {
    ar: {
      ...
      overview: "يعبّئ نظام تخزين الطاقة بحاوية من هايسِن راكات البطارية وPCS وEMS وإدارة حرارية وإخماد حريق داخل حاوية ISO مصنفة للخارج، للنشر المستقل عن الموقع حيث لا تتوفر مساحة داخلية أو تلزم سعة تخزين أكبر.",
    ...
    fr: {
      ...
      overview: "Le système de stockage d'énergie conteneurisé Haisen regroupe des racks de batteries, PCS, EMS, gestion thermique et extinction incendie à l'intérieur d'un conteneur ISO classé pour l'extérieur, pour un déploiement indépendant du site lorsque l'espace intérieur n'est pas disponible ou qu'une plus grande capacité de stockage est nécessaire.",
    ...
    ru: {
      ...
      overview: "Контейнерная система накопления энергии Haisen объединяет стойки батарей, PCS, EMS, терморегулирование и пожаротушение внутри рассчитанного на наружную установку ISO-контейнера для развёртывания независимо от объекта, когда внутреннее пространство недоступно или требуется большая ёмкость накопления.",
    ...
    zh: {
      ...
      overview: "海森集装箱式储能系统将电池组、PCS、EMS、热管理及消防系统集成于户外级ISO集装箱内,适用于无室内空间或需要更大储能容量的独立场地部署场景。",
