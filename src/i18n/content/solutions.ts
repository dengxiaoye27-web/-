...
export const solutionContentTranslations: Record<string, Record<TranslatedLocale, SolutionContent>> = {
  "data-center-infrastructure": {
    ar: {
      ...
      solutionArchitecture:
        "تصمم واندتونغ منظومة البنية التحتية الكاملة كنظام واحد منسق: يغذي دخل المرافق/المولد أنظمة UPS الزائدة، وتُوزَّع الطاقة إلى الراكات عبر وحدات PDU الذكية، ويقع حمل تكنولوجيا المعلومات في خزانات مصممة هندسياً مع احتواء الممر الساخن/البارد، ويُزيل التبريد الدقيق أو السائل الحرارة، وتربط طبقة المراقبة الطاقة والبيئة والأمن معاً.",
      systemComponents: [
      ...
      faqs: [
        {
          question: "هل تصمم واندتونغ بنية تحتية كاملة لمراكز البيانات وليس منتجات فردية فقط؟",
          answer:
            "نعم. تصمم واندتونغ أنظمة متناسقة للطاقة والتبريد والخزانات والمراقبة كحل بنية تحتية واحد، مُحجَّم ومدمج معاً بدلاً من بيعه كمكونات منفصلة.",
        },
      ],
    },
    fr: {
      ...
      faqs: [
        {
          question: "Wandtung conçoit-elle une infrastructure complète de centre de données, pas seulement des produits individuels ?",
          answer:
            "Oui. Wandtung conçoit des systèmes coordonnés d'alimentation, de refroidissement, d'enceintes et de surveillance comme une solution d'infrastructure unique, dimensionnée et intégrée ensemble plutôt que vendue sous forme de composants séparés.",
        },
      ],
    },
    es: {
      ...
      faqs: [
        {
          question: "¿Wandtung diseña infraestructura completa para centros de datos, no solo productos individuales?",
          answer:
            "Sí. Wandtung diseña sistemas coordinados de energía, refrigeración, gabinetes y monitoreo como una solución de infraestructura única, dimensionada e integrada en conjunto en lugar de venderse como componentes desconectados.",
        },
      ],
    },
    ru: {
      ...
      faqs: [
        {
          question: "Проектирует ли Wandtung полную инфраструктуру ЦОД, а не только отдельные продукты?",
          answer:
            "Да. Wandtung проектирует согласованные системы питания, охлаждения, шкафов и мониторинга как единое инфраструктурное решение, рассчитанное и интегрированное вместе, а не продаваемое как разрозненные компоненты.",
        },
      ],
    },
    zh: {
      ...
      solutionArchitecture:
        "万电通将完整的基础设施体系设计为一套协同系统：市电/发电机输入为冗余UPS供电,电力通过智能PDU分配至机柜,IT负载置于配备冷热通道封闭的工程化机柜中,精密或液冷系统负责散热,监控层将电力、环境与安防统一整合。",
      systemComponents: [
      ...
      faqs: [
        {
          question: "万电通是否提供完整的数据中心基础设施设计,而不仅是单一产品？",
          answer: "是的。万电通将电力、制冷、机柜与监控系统作为统一的基础设施解决方案进行协同设计与集成交付,而非作为分散的组件单独销售。",
        },
      ],
    },
  },
  ...
  "micro-modular-data-center": {
    ar: {
      ...
      solutionArchitecture:
        "تدمج واندتونغ مسبقاً خزانات تكنولوجيا المعلومات وUPS وPDU والتبريد والبطارية ومكافحة الحريق والتحكم بالدخول ومراقبة البيئة في وحدة مصغرة موحدة، تُختبر في المصنع كنظام كامل وتُشحن جاهزة للتموضع والتشغيل في الموقع.",
      systemComponents: [
    ...
    fr: {
      ...
      solutionArchitecture:
        "Wandtung préintègre les baies informatiques, l'onduleur, le PDU, le refroidissement, la batterie, l'extinction incendie, le contrôle d'accès et la surveillance environnementale dans un micro-module standardisé, testé en usine comme système complet et expédié prêt pour la mise en place et la mise en service sur site.",
      systemComponents: [
    ...
    es: {
      ...
      solutionArchitecture:
        "Wandtung preintegra gabinetes de TI, SAI, PDU, refrigeración, batería, supresión de incendios, control de acceso y monitoreo ambiental en un micromódulo estandarizado, probado en fábrica como sistema completo y enviado listo para su colocación y puesta en marcha en el sitio.",
      systemComponents: [
    ...
    ru: {
      ...
      solutionArchitecture:
        "Wandtung предварительно интегрирует ИТ-шкафы, ИБП, PDU, охлаждение, батареи, пожаротушение, контроль доступа и мониторинг среды в стандартизированный микромодуль, который проходит заводские испытания как единая система и поставляется готовым к размещению и вводу в эксплуатацию на объекте.",
      systemComponents: [
    ...
    zh: {
      ...
      solutionArchitecture:
        "万电通将IT机柜、UPS、PDU、制冷、电池、气体消防、门禁及环境监控预集成为标准化微模块,在工厂作为完整系统进行测试,交付后即可在现场安装并调试。",
      systemComponents: [
  ...
  "containerized-data-center": {
    ar: {
      ...
      solutionArchitecture:
        "تدمج واندتونغ خزانات تكنولوجيا المعلومات وتوزيع الطاقة وUPS والتبريد والحماية من الحريق والأمن والمراقبة داخل هيكل حاوية ISO معزول ومقوى، مصمم هندسياً للنشر الخارجي والتوصيل السريع بطاقة وشبكة الموقع.",
      systemComponents: [
      ...
      faqs: [
        {
          question: "هل توفر واندتونغ مراكز بيانات حاوية؟",
          answer:
            "نعم. تصنع واندتونغ مراكز بيانات حاوية بطول 20 و40 قدماً مدمجة مسبقاً مع خزانات تكنولوجيا المعلومات وتوزيع الطاقة وUPS والتبريد والحماية من الحريق والمراقبة لنشر الاتصالات والتعدين والنفط والغاز والحوسبة الطرفية والحكومة.",
        },
      ],
    },
    fr: {
      ...
      solutionArchitecture:
        "Wandtung intègre les baies informatiques, la distribution électrique, l'onduleur, le refroidissement, la protection incendie, la sécurité et la surveillance à l'intérieur d'une coque de conteneur ISO renforcée et isolée, conçue pour un déploiement extérieur et une connexion rapide à l'alimentation et au réseau du site.",
      systemComponents: [
      ...
      faqs: [
        {
          question: "Wandtung propose-t-elle des centres de données conteneurisés ?",
          answer:
            "Oui. Wandtung fabrique des centres de données conteneurisés de 20 et 40 pieds préintégrés avec baies informatiques, distribution électrique, onduleur, refroidissement, protection incendie et surveillance pour les déploiements télécoms, miniers, pétroliers et gaziers, d'edge computing et gouvernementaux.",
        },
      ],
    },
    es: {
      ...
      solutionArchitecture:
        "Wandtung integra gabinetes de TI, distribución de energía, SAI, refrigeración, protección contra incendios, seguridad y monitoreo dentro de una carcasa de contenedor ISO reforzada y aislada, diseñada para despliegue exterior y conexión rápida a la energía y red del sitio.",
      systemComponents: [
      ...
      faqs: [
        {
          question: "¿Wandtung ofrece centros de datos en contenedores?",
          answer:
            "Sí. Wandtung fabrica centros de datos en contenedores de 20 y 40 pies preintegrados con gabinetes de TI, distribución de energía, SAI, refrigeración, protección contra incendios y monitoreo para despliegues de telecomunicaciones, minería, petróleo y gas, edge computing y gobierno.",
        },
      ],
    },
    ru: {
      ...
      solutionArchitecture:
        "Wandtung интегрирует ИТ-шкафы, распределение питания, ИБП, охлаждение, пожарную защиту, безопасность и мониторинг внутри усиленного утеплённого корпуса ISO-контейнера, рассчитанного на наружное размещение и быстрое подключение к питанию и сети площадки.",
      systemComponents: [
      ...
      faqs: [
        {
          question: "Предоставляет ли Wandtung контейнерные дата-центры?",
          answer:
            "Да. Wandtung производит контейнерные дата-центры длиной 20 и 40 футов с предварительно интегрированными ИТ-шкафами, распределением питания, ИБП, охлаждением, пожарной защитой и мониторингом для телеком-, горнодобывающих, нефтегазовых, периферийных и государственных проектов.",
        },
      ],
    },
    zh: {
      ...
      solutionArchitecture:
        "万电通将IT机柜、配电、UPS、制冷、消防、安防与监控集成于加固保温的ISO集装箱结构内,专为户外部署及快速接入现场电力与网络而设计。",
      systemComponents: [
      ...
      faqs: [
        {
          question: "万电通是否提供集装箱数据中心？",
          answer: "是的。万电通生产20英尺及40英尺集装箱数据中心,预集成IT机柜、配电、UPS、制冷及监控系统,适用于电信、矿业、石油天然气、边缘计算及政府类部署项目。",
        },
      ],
    },
  },
  ...
  "edge-data-center": {
    ar: {
      ...
      solutionArchitecture:
        "تجمع واندتونغ بين وحدات مصغرة مدمجة أو وحدات حاوية مع طاقة مرنة (UPS + بطارية) ومراقبة عن بُعد وإدارة بدون إضاءة للمواقع الطرفية غير المراقَبة.",
      systemComponents: [
      ...
      faqs: [
        {
          ...
          answer:
            "تُعطي مراكز البيانات الطرفية الأولوية للبصمة المدمجة والتشغيل عن بُعد/غير المراقَب للمواقع الموزعة، بينما تُحجَّم مراكز البيانات الحاوية عادةً لسعة أكبر ومستقلة في موقع نائي واحد — تُستخدم وحدات واندتونغ المصغرة والحاوية الأصغر كلبنات بناء للنشر الطرفي.",
        },
      ],
    },
    fr: {
      ...
      solutionArchitecture:
        "Wandtung combine des micro-modules compacts ou des unités conteneurisées avec une alimentation résiliente (onduleur + batterie), une surveillance à distance et une gestion « lights-out » pour les sites edge non surveillés.",
      systemComponents: [
    ...
    es: {
      ...
      solutionArchitecture:
        'Wandtung combina micromódulos compactos o unidades en contenedor con energía resiliente (SAI + batería), monitoreo remoto y gestión "lights-out" para sitios edge no supervisados.',
      systemComponents: [
    ...
    ru: {
      ...
      solutionArchitecture:
        "Wandtung сочетает компактные микромодули или контейнерные блоки с отказоустойчивым питанием (ИБП + батарея), удалённым мониторингом и безлюдным управлением для необслуживаемых периферийных площадок.",
      systemComponents: [
      ...
      faqs: [
        {
          ...
          answer:
            "Периферийные дата-центры делают акцент на компактности и удалённой/безлюдной эксплуатации для распределённых площадок, тогда как контейнерные дата-центры обычно рассчитаны на большую автономную мощность в одной удалённой локации — микромодули и небольшие контейнерные блоки Wandtung служат строительными элементами для edge-развёртываний.",
        },
      ],
    },
    zh: {
      ...
      solutionArchitecture:
        "万电通将紧凑型微模块或集装箱单元与高韧性电力(UPS+电池)、远程监控及无人值守管理相结合,适用于无人值守的边缘场地。",
      systemComponents: [
      ...
      faqs: [
        {
          ...
          answer: "边缘数据中心更注重紧凑占地与分布式场地的远程/无人值守运行,而较大型的集装箱数据中心通常在单个远程场地提供更大的自持容量——万电通的微模块与小型集装箱单元正是边缘部署的基础构建模块。",
        },
      ],
    },
  },
  ...
  "telecom-data-center": {
    ar: {
      ...
      solutionArchitecture:
        "توفر واندتونغ خزانات الراك والشبكة، وتوزيع طاقة التيار المستمر/المتردد، وUPS، وخيارات حاوية موحدة لغرف معدات الاتصالات وقابلة للتكرار السريع عبر مواقع عديدة.",
      systemComponents: [
    ...
    fr: {
      ...
      solutionArchitecture:
        "Wandtung fournit des baies rack et réseau, une distribution électrique CC/CA, des onduleurs et des options conteneurisées standardisées pour les salles d'équipements télécoms, rapidement reproductibles sur de nombreux sites.",
      systemComponents: [
    ...
    es: {
      ...
      solutionArchitecture:
        "Wandtung suministra gabinetes de rack y red, distribución de energía CC/CA, SAI y opciones en contenedor estandarizadas para salas de equipos de telecomunicaciones, replicables rápidamente en muchos sitios.",
      systemComponents: [
    ...
    ru: {
      ...
      solutionArchitecture:
        "Wandtung поставляет стоечные и сетевые шкафы, распределение питания DC/AC, ИБП и контейнерные варианты, стандартизированные для помещений телеком-оборудования и легко тиражируемые на множестве объектов.",
      systemComponents: [
    ...
    zh: {
      ...
      solutionArchitecture: "万电通为电信设备间提供标准化的机柜、网络机柜、直流/交流配电、UPS及集装箱选项,可在众多站点间快速复制部署。",
      systemComponents: [
  ...
  "liquid-cooling": {
    ar: {
      ...
      solutionArchitecture:
        "يُطبِّق حل التبريد السائل من واندتونغ تبريداً مباشراً للرقاقة بصفيحة باردة على مستوى الخادم، مع CDU يعزل ويدير حلقات سائل التبريد الأساسية (المرفق) والثانوية (الراك)، بما يشمل كشف التسرب والمراقبة.",
      systemComponents: [
    ...
    fr: {
      ...
      solutionArchitecture:
        "La solution de refroidissement liquide de Wandtung applique un refroidissement direct à la puce par plaque froide au niveau du serveur, avec un CDU isolant et gérant les boucles de liquide de refroidissement primaire (installation) et secondaire (baie), incluant détection de fuite et surveillance.",
      systemComponents: [
    ...
    es: {
      ...
      solutionArchitecture:
        "La solución de refrigeración líquida de Wandtung aplica refrigeración directa al chip mediante placa fría a nivel de servidor, con un CDU que aísla y gestiona los bucles de refrigerante primario (instalación) y secundario (rack), incluyendo detección de fugas y monitoreo.",
      systemComponents: [
    ...
    ru: {
      ...
      solutionArchitecture:
        "Решение Wandtung по жидкостному охлаждению применяет прямое охлаждение чипа холодной плитой на уровне сервера, а CDU изолирует и управляет первичным (объектовым) и вторичным (стоечным) контурами хладагента, включая обнаружение утечек и мониторинг.",
      systemComponents: [
  ...
  "critical-power": {
    ar: {
      ...
      solutionArchitecture:
        "تصمم واندتونغ بنى طاقة زائدة تجمع بين تبديل نقل ATS/STS، وUPS معياري، ووحدات PDU ذكية، مُراقَبة من طرف إلى طرف بحيث يمكن للمشغلين رؤية المشكلات والاستجابة لها قبل أن تؤثر على الحمل.",
      systemComponents: [
    ...
    fr: {
      ...
      solutionArchitecture:
        "Wandtung conçoit des architectures d'alimentation redondantes combinant commutation de transfert ATS/STS, onduleur modulaire et PDU intelligents, surveillés de bout en bout afin que les opérateurs puissent détecter et résoudre les problèmes avant qu'ils n'affectent la charge.",
      systemComponents: [
    ...
    es: {
      ...
      solutionArchitecture:
        "Wandtung diseña arquitecturas de energía redundantes que combinan conmutación de transferencia ATS/STS, SAI modular y PDU inteligentes, monitoreadas de extremo a extremo para que los operadores puedan detectar y responder a problemas antes de que afecten la carga.",
      systemComponents: [
    ...
    ru: {
      ...
      solutionArchitecture:
        "Wandtung проектирует резервируемые архитектуры питания, сочетающие переключение ATS/STS, модульные ИБП и интеллектуальные PDU, с мониторингом на всех этапах, чтобы операторы могли выявлять и устранять проблемы до того, как они повлияют на нагрузку.",
      systemComponents: [
    ...
    zh: {
      ...
      solutionArchitecture:
        "万电通设计集成ATS/STS转换开关、模块化UPS及智能PDU的冗余电力架构,实现端到端监控,使运营方能够在问题影响负载前及时发现并处理。",
      systemComponents: [
  ...
  "smart-power-distribution": {
    ar: {
      ...
      solutionArchitecture:
        "تنشر واندتونغ وحدات PDU ذكية مع اتصال SNMP/Modbus/RS485 عبر المنشأة، تغذي منصة مراقبة مركزية لرؤية الطاقة والطاقة والبيئة في الوقت الفعلي مع تحكم عن بُعد بالمنفذ.",
      systemComponents: [
      ...
      faqs: [
        {
          question: "ما بروتوكولات الاتصال التي تدعمها وحدات PDU الذكية من واندتونغ؟",
          answer:
            "تدعم وحدات PDU الذكية من واندتونغ SNMP (v1/v2c/v3)، وModbus RTU/TCP، وRS485، وTCP/IP، ما يتيح التكامل مع معظم منصات DCIM وإدارة المباني.",
        },
      ],
    },
    fr: {
      ...
      solutionArchitecture:
        "Wandtung déploie des PDU intelligents avec connectivité SNMP/Modbus/RS485 dans toute l'installation, alimentant une plateforme de surveillance centralisée pour une visibilité en temps réel de l'énergie, de la consommation et de l'environnement, avec contrôle des prises à distance.",
      systemComponents: [
      ...
      faqs: [
        {
          question: "Quels protocoles de communication les PDU intelligents Wandtung prennent-ils en charge ?",
          answer:
            "Les PDU intelligents Wandtung prennent en charge SNMP (v1/v2c/v3), Modbus RTU/TCP, RS485 et TCP/IP, permettant l'intégration avec la plupart des plateformes DCIM et de gestion technique du bâtiment.",
        },
      ],
    },
    es: {
      ...
      solutionArchitecture:
        "Wandtung despliega PDU inteligentes con conectividad SNMP/Modbus/RS485 en toda la instalación, alimentando una plataforma de monitoreo centralizada para visibilidad en tiempo real de energía, consumo y entorno, con control remoto de tomas.",
      systemComponents: [
      ...
      faqs: [
        {
          question: "¿Qué protocolos de comunicación admiten los PDU inteligentes de Wandtung?",
          answer:
            "Los PDU inteligentes de Wandtung admiten SNMP (v1/v2c/v3), Modbus RTU/TCP, RS485 y TCP/IP, permitiendo la integración con la mayoría de las plataformas DCIM y de gestión de edificios.",
        },
      ],
    },
    ru: {
      ...
      solutionArchitecture:
        "Wandtung развёртывает интеллектуальные PDU с подключением по SNMP/Modbus/RS485 по всему объекту, передавая данные на централизованную платформу мониторинга для видимости питания, энергопотребления и среды в реальном времени с удалённым управлением розетками.",
      systemComponents: [
      ...
      faqs: [
        {
          question: "Какие протоколы связи поддерживают интеллектуальные PDU Wandtung?",
          answer:
            "Интеллектуальные PDU Wandtung поддерживают SNMP (v1/v2c/v3), Modbus RTU/TCP, RS485 и TCP/IP, что позволяет интегрироваться с большинством платформ DCIM и управления зданием.",
        },
      ],
    },
    zh: {
      ...
      solutionArchitecture:
        "万电通在设施内部署具备SNMP/Modbus/RS485连接能力的智能PDU,数据汇入集中监控平台,实现电力、能耗与环境的实时可视化及远程出口控制。",
      systemComponents: [
      ...
      faqs: [
        {
          question: "万电通智能PDU支持哪些通信协议？",
          answer: "万电通智能PDU支持SNMP(v1/v2c/v3)、Modbus RTU/TCP、RS485及TCP/IP,可与大多数DCIM及楼宇管理平台集成。",
        },
      ],
    },
  },
  ...
  "energy-storage": {
    ar: {
      ...
      solutionArchitecture:
        "تدمج واندتونغ راكات البطاريات وPCS وEMS في أنظمة تخزين طاقة بالبطارية بشكل خزانة أو حاوية، قابلة للتكوين للطاقة الاحتياطية أو خفض الذروة أو التكامل مع الطاقة المتجددة (الشمسية).",
      systemComponents: [
    ...
    fr: {
      ...
      solutionArchitecture:
        "Wandtung intègre des racks de batteries, un PCS et un EMS dans des systèmes de stockage d'énergie par batterie en armoire ou conteneurisés, configurables pour l'alimentation de secours, l'écrêtage de charge ou l'intégration d'énergies renouvelables (solaire).",
      systemComponents: [
    ...
    es: {
      ...
      solutionArchitecture:
        "Wandtung integra racks de baterías, PCS y EMS en sistemas de almacenamiento de energía en gabinete o en contenedor, configurables para energía de respaldo, reducción de picos o integración de renovables (solar).",
      systemComponents: [
    ...
    ru: {
      ...
      solutionArchitecture:
        "Wandtung интегрирует аккумуляторные стойки, PCS и EMS в шкафные или контейнерные системы накопления энергии, настраиваемые для резервного питания, выравнивания пиковой нагрузки или интеграции возобновляемых источников (солнечной энергии).",
      systemComponents: [
    ...
    zh: {
      ...
      solutionArchitecture:
        "万电通将电池组、PCS(电力转换系统)与EMS(能量管理系统)集成为柜式或集装箱式电池储能系统,可配置用于备用电源、削峰填谷或新能源(光伏)接入。",
      systemComponents: [
