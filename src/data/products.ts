...
export const products: Product[] = [
  ...
  // ---------------- Raised Floor ----------------
  {
    ...
    images: [
      ...
      "/products/anti-static-raised-floor/03-installation-system.jpg",
      "/products/anti-static-raised-floor/04-data-center-scene.jpg",
      "/products/anti-static-raised-floor/05-pedestal-detail.jpg",
      "/products/anti-static-raised-floor/06-key-features-overview.jpg",
    ],
    keyFeatures: [
      "Anti-static PVC surface, 10^6–10^9 Ω surface resistance",
      "3-layer construction: SPCC cold-rolled steel surface, deep-drawn coil steel dimple base, high-density foamed cement core",
      "Precision interlocking / cornerlock edge system for a tight, stable joint",
      "Height-adjustable steel pedestal, 100–500mm",
      "Easy, tool-light installation",
      "CE and ISO certified, OEM/ODM available",
    ],
    specGroups: [
      {
        ...
        specs: [
          ...
          { label: "Construction", value: "3-layer: steel surface, deep-drawn steel base, foamed cement core" },
          { label: "Load Rating", value: "800–1200 kg/m² (model dependent)" },
      ...
      },
      {
        ...
        specs: [
          { label: "Pedestal Material", value: "Steel, height-adjustable" },
          { label: "Height Range", value: "100–500mm, adjustable" },
          { label: "Edge System", value: "Precision interlocking / cornerlock" },
        ],
      },
    ],
    ...
    faqs: [
      ...
      {
        question: "What does the precision interlocking cornerlock system do?",
        answer:
          "The cornerlock system joins adjacent panels at a precise, tight edge, keeping the floor surface stable underfoot and free of gaps that could otherwise let underfloor air escape unevenly or create trip hazards.",
      },
    ],
  ...
  },
  {
    ...
    images: [
      ...
      "/products/wire-mesh-cable-tray/02-installation-detail.jpg",
      "/products/wire-mesh-cable-tray/03-bracket-detail.jpg",
      "/products/wire-mesh-cable-tray/04-top-view.jpg",
      "/products/wire-mesh-cable-tray/05-weave-closeup.jpg",
    ],
    keyFeatures: [
